...
export function useOperationGameEngine<Q>(generator: QuestionGenerator<Q>, deps?: Partial<GameEngineDeps>) {
  ...
  const record = useCallback((question: Q, correct: boolean, durationMs?: number) => {
